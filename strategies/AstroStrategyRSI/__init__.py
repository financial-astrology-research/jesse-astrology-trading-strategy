...
class AstroStrategyRSI(Strategy):
    ...
    def go_long(self):
        ...
        self.vars['last_rsi_cross_long'] = self.index
    ...
    def go_short(self):
        ...
        self.vars['last_rsi_cross_short'] = self.index
    ...
    @cached
    def rsi(self):
        return ta.ift_rsi(self.candles, sequential=True)
